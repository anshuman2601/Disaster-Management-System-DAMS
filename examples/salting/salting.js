...
console.log('testing testpass = hash: ' + (hashed['passwordHash'] == testHashed['passwordHash']));
console.log('testing testpass1 = hash: ' + (hashed['passwordHash'] == testHashed2['passwordHash']));
