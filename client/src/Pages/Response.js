          ...
          <TableBody>
            {response.map((response, index) => (
              <TableRow key={response.id}>
                ...
                <TableCell align="right">{response.event}</TableCell>
                <TableCell align="right">{response.date_of_occurrence}</TableCell>
                <TableCell align="right">{response.location}</TableCell>
